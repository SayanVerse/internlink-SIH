...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are InternLink Bot, a helpful assistant for the PM Internship Scheme platform. 
...
Be helpful, concise, and friendly. Keep responses short and to the point.`;
